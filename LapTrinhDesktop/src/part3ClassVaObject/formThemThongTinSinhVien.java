 ...
 * @author Giang Vu
 */
public class formThemThongTinSinhVien extends javax.swing.JFrame {

    /**
     * Khai bao 1 thuoc tinh de co the luu ma sinh vien tu danh sach gui len trong truong hop sua
     */
    private String maSV = "";
     ...
     */
    public formThemThongTinSinhVien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnCapNhap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/part3ClassVaObject/Images/capNhap.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtDienThoai, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(21, 21, 21)
    ...
    private void btnCapNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhapActionPerformed
        ...
        {
            // Goi ham sua
            ketQuaCapNhap = DataProvider.QLSinhVien().capNhapSinhVien(objSV);
        }
        else
        {
            ketQuaCapNhap = DataProvider.QLSinhVien().themSinhVien(objSV);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formThemThongTinSinhVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formThemThongTinSinhVien().setVisible(true);
            }
        });
    }
    ...
    private void hienThiChiTietSinhVien() {
        ...
        SinhVien objSV = DataProvider.QLSinhVien().timKiemTheoMaSV(maSV);
        if (objSV != null)
        {
            ...
            if (objSV.getGioiTinh() == 1) // Neu la nu
            {
